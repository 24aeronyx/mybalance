...
class ProfilePage extends GetView<ProfileController> {
  ...
  Future<void> _refreshData() async {
    await controller.fetchProfile(); // Memanggil ulang fungsi untuk mengambil data profil
  }
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: RefreshIndicator(
          onRefresh: _refreshData, // Menentukan fungsi yang akan dipanggil saat di-refresh
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          Get.toNamed('/edit-profile'); // Navigate to the edit profile page
                        },
                        child: const Icon(
                          Icons.edit,
                          color: Colors.white,
